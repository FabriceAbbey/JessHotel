...
//        return $this->render('hotel/booking.html.twig', array('reservation' => $randomString));
    ...
    /**
     * @Route("/about-us/", name="hotel_about_us")
     */
    public function aboutUsAction()
    {

        return $this->render('hotel/about-us.html.twig');
    }

    /**
     * @Route("/services/", name="hotel_services")
     */
    public function servicesAction()
    {
        $services = $this->getDoctrine()->getRepository('AppBundle:Service')->findAll();

        return $this->render('hotel/services.html.twig', array("services" => $services));
    }

    /**
     * @Route("/gallery/", name="hotel_gallery")
     */
    public function galleryAction()
    {

        return $this->render('hotel/gallery.html.twig');
    }

    /**
     * @Route("/contact/", name="hotel_contact")
     */
...
<style>.header{background:#337ab7;}.header p{color:#ffffff;margin:0;}.header .columns{padding-bottom:0;}.header .container{background:#337ab7;padding-top:16px;padding-bottom:16px;}.header .container td{padding-top:16px;padding-bottom:16px;}</style>
<body>
...
<table>
<tr>
<th> <img style="width: 89px;height: 57px;"src="http://local.fasoenergysolution.com/img/logo_fes_burned.png"> </th>
</tr>
</table>
</th>
...
<tr>
<th>
<p class="text-right"><a style="color: white;" href="http://fasoenergysolutions.com"> Faso Energy Solutions</a></p>
</th>
</tr>
</table>
</th>
...
<p>Merci de l\'importance que vous nous accorder. Nous nous ferons un plaisir de vous répondre dans les plus brefs délais. </p>
</td>
...
<tr>
<td>
<center data-parsed=""><a href="#" align="center" class="text-center">Facebook</a></center>
</td>
<td class="expander"></td>
</tr>
</table>
...
<tr>
<td>
<center data-parsed=""><a href="#" align="center" class="text-center">Twitter</a></center>
</td>
<td class="expander"></td>
</tr>
</table>
...
<tr>
<td>
<center data-parsed=""><a href="#" align="center" class="text-center">Google+</a></center>
</td>
<td class="expander"></td>
</tr>
</table>
...
<p>Phone: (+226)65224460</p>
<p>Email: <a href="mailto:info@fasoenergysolutions.com">info@fasoenergysolutions.com</a></p>
</td>
<td class="expander"></td>
</tr>
</table>

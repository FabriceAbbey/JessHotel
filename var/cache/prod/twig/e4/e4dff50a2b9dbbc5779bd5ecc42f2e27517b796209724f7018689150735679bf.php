...
class __TwigTemplate_3ce7308253342568ed1de097529f43a5fc8eadff99ff548a929fb2807ee58119 extends Twig_Template
{
    ...
    public function block_main($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("http_error.name", array("%status_code%" => 404)), "html", null, true);
        echo "</h1>

    <p class=\"lead\">
        ";
        // line 19
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("http_error_404.description"), "html", null, true);
        echo "
    </p>
    <p>
        ";
        // line 22
        echo $this->env->getExtension('translator')->trans("http_error_404.suggestion", array("%url%" => $this->env->getExtension('routing')->getPath("blog_index")));
        echo "
    </p>
";
    }
